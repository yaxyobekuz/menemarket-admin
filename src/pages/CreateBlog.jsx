...
const CreateBlog = () => {
  ...
  const handleCreateBlog = (e) => {
    ...
    blogsService
      ...
      .catch(() => notification.error("Blogni yaratishda xatolik"))
      .finally(() => setIsLoading(false));
  };

  return isCrated ? (
    <div className="absolute top-1/2 right-1/2 translate-x-1/2 -translate-y-1/2">
      <PageMessage title="Blog yaratildi!" sticker={likeOutSticker} />
    </div>
  ) : (
    <div className="container py-6 space-y-7">
      ...
      <div className="flex flex-col gap-5 w-full lg:flex-row">
        ...
        {/* Form */}
        <form onSubmit={handleCreateBlog} className="w-full space-y-5">
          {/* Name */}
          <FormInputWrapper
            required
            name="title"
